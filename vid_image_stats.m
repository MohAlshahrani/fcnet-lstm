...
% ------------------------------------------------------------------------
    ...
    for v=1:n_video_train
        ...
        for o=1:samples_per_video
            crops_z_string{o} = [base_path strrep(imdb_video.objects{v}{rand_objs(o)}.frame_path, '.jpg','') '.' num2str(imdb_video.objects{v}{rand_objs(o)}.track_id, '%02d') '.crop.z.jpg'];
            crops_x_string{o} = [base_path strrep(imdb_video.objects{v}{rand_objs(o)}.frame_path, '.jpg','') '.' num2str(imdb_video.objects{v}{rand_objs(o)}.track_id, '%02d') '.crop.x.jpg'];
        end
